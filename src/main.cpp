...
void changeSystemIcons() {
    ...
    "{B4BF210D-05F5-425F-8BCC-277D2B055117}",
    "{F8CD748C-7616-4744-AF72-132E0E64386F}",
    "{59031A47-3F72-44A7-89C5-5595FE6B30EE}",
    "{031E4825-7B94-4DC3-B131-E946B44C8DD5}",
    "{80317208-189D-423F-B91A-2565691F5B54}",
    "{E88865EA-0E1C-4E20-9AA6-EDCD0212C87C}",
    "{F87432D7-B6B7-47D3-B186-0D12E617D591}",
    "{679F85D2-5B40-42C2-B9B3-35D003424E83}",
    "{BF40CA97-3196-4F0A-BF59-617F5B129188}",
    "{1D2680C3-8023-4381-B584-00234B5C6C11}",
    ...
    "{30B55822-692B-470B-8849-9B0D9D490744}",
    ...
    "{F0D44F50-3221-4707-A414-02202356C9C2}",
    "{508224B0-2139-4BE9-B508-950E9A6F3702}",
    "{4234D49B-0245-4DF3-B780-3893943456E1}",
    "{E88DCCE0-B7B3-11D1-A9F0-0000F8751DA1}",
    ...
    "{9DB7A13C-FCD0-4A38-B925-B0F7220B34A3}",
    ...
    "{1E020A25-E082-435A-8A0D-2ECE0A260D19}",
    "{625B53C3-2B2E-470F-A80A-01A635B04723}",
    "{A4115719-D62E-491D-AA7C-E74B8BE3B0E1}",
    "{A7CA5245-A88B-4412-A677-43C3E200AE62}",
    "{0138D086-0507-492B-8C5E-05B36D0C5716}",
    "{3080F90D-D7AD-11D9-BD98-0000947B0257}",
    "{3080F90E-D7AD-11D9-BD98-0000947B0257}",
    "{0AC0837C-BBF8-452A-850D-EBE3BFB5D24F}",
    "{1740E05A-4FEA-443E-A2A0-03A4F1B4EE7E}",
    "{C2F03A33-21F5-47FA-B4BB-156362A2F239}",
    "{4BD61FA9-731A-483B-A984-7546E8B622A6}",
    "{28A28E2A-D40A-4211-BE80-AE64BE928919}",
    "{2559A1F6-21D7-11D4-BDAF-00C04F60B9F0}",
    "{865E5E76-AD83-4DCA-A109-50DC2113CE9A}",
    "{48286C08-0A5B-4262-81D2-870B92B23910}",
    "{F312A27F-7028-450A-8350-B48A2C029B4F}",
    "{E08233C2-0010-441C-A4D8-A8A24F181B1A}",
    "{000214E6-0000-0000-C000-000000000046}",
    "{520F25D0-5800-400B-AE9F-0E0C51390A70}",
    "{31C822CD-6A50-4B19-866F-8A02A0B75206}",
    "{E52243C2-0C82-4F18-8A3F-01A1054C349D}",
    "{C62A69F0-16DC-4F92-A019-3233A3A93F69}",
    "{49AD3B3D-A3D9-4E61-ADCB-680F21884F2E}",
    "{2D15A202-A62E-4161-949B-57A3C569D1E4}",
    "{018D5C66-4533-4307-9B53-224DE2ED1FE6}",
    "{A52BBA46-E9E1-435F-B3D9-28DAA648C0F6}",
    "{04271989-C4D2-4111-921E-83C30B6B48A6}" 
};
